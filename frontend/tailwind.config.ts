  ...
  theme: {
    extend: {
      colors: {
        ...
        "c-text-faint": "var(--color-text-faint)",
        "c-accent": "var(--color-accent)",
        "c-bg-root": "var(--color-bg-root)",
        "c-bg-surface": "var(--color-bg-surface)",
        "c-bg-elevated": "var(--color-bg-elevated)",
        "c-bg-overlay": "var(--color-bg-overlay)",
        "c-bg-hover": "var(--color-bg-hover)",
        "c-border": "var(--color-border)",
        "c-border-subtle": "var(--color-border-subtle)",
        "c-border-accent": "var(--color-border-accent)",
